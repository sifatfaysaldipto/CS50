...
bool has_cycle(int winner, int loser); // Added prototype for has_cycle
...
int main(int argc, string argv[])
{
    ...
    // Clear graph of locked pairs and the preferences array
    for (int i = 0; i < candidate_count; i++)
    {
    ...
    {
        // ranks[i] represents the voter's i-th preference
...
// Function used for sorting pairs
int comparator(const void *a, const void *b)
{
    pair *ab = (pair *)a;
    pair *ba = (pair *)b;
...
// Check for cycle in the graph using Depth First Search
